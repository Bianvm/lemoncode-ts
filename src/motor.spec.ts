...
describe('./src/motor.ts', () => {
    describe('obtenerEstadoPartida', () => {
        it("debería devolver POR_DEBAJO_MAXIMO si puntuación < 7.5", () => {
        ...
        it("debería devolver TE_HAS_PASADO si puntuación > 7.5", () => {
    ...
    describe('puntosPorCarta', () => {
        it("debería devolver 0.5 si numeroCarta > 7", () => {
        ...
        it("debería devolver valorCarta = numeroCarta si numeroCarta < 7", () => {
            const numeroCarta = 1;
